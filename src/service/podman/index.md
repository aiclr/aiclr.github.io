...
**_docker hub_** 国内加速镜像配置文件 **_/etc/containers/registries.conf_**
...
- **_podman images_** list all images
- **_podman ps_** Listing running containers
- **_podman ps -a_** Listing all containers
- **_podman inspect -l | grep IPAddress_** Inspecting a running container
- **_podman logs -l_** Viewing the container’s logs
- **_podman top -l_** Viewing the container’s pids
- **_podman stop -l_** Stopping the container
- **_podman rm -l_** Removing the container
