...
The [equalalways](../../options.md#equalalways-ea-noequalalways-noea) option, when set, makes Vim equalize the windows sizes when a window is closed or opened.
...
More commands to move to other windows: [Q_wi](../../quickref.md#q_wi-multi-window-commands).
...
For details about diff mode, see [vimdiff](../../diff.md)
...
The [splitbelow](../../options.md#splitbelow-sb-nosplitbelow-nosb) option can be set to make a new window appear below the current window. The [splitright](../../options.md#splitright-spr-nosplitright-nospr) option can be set to make a vertically split window appear right of the current window.
...
For more information about tab pages see [tab-page](../../tabpage.md).
