...
Do the Vim tutor, a 30-minute interactive course for the basic commands,see [vimtutor]().Read the [user manual](user_manual/index.md) form start to end:[usr_01](user_manual/getting_started/usr_01.md).
