...
On MS-Windows you can find it in the Program/Vim menu. Or execute **_vimtutor.bat_** in the **$VIMRUNTIME** directory.
...
- Copy the tutor file. You can do this with Vim (it knows where to find it):
  - `vim --clean -c 'e $VIMRUNTIME/tutor/tutor' -c 'w! TUTORCOPY' -c 'q'`. This will write the file **_TUTORCOPY_** in the current directory.
...
- Edit the copied file with Vim: `vim --clean TUTORCOPY`. The **_--clean_** argument makes sure Vim is started with noce defaults.
