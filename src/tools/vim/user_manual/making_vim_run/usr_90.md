...
You can put these lines in your ***vimrc*** file, see [05.1](../getting_started/usr_05.md#051-the-vimrc-file). A disadvantage is that it won't work when you use another terminal some day. Look here for alternate solutions: [:fixdel](#).
...
Use the example ***vimrc*** script. You can find an explanation on how to use it here: [not-compatible](../getting_started/usr_01.md#not-compatible).

See chapter 6 for information about syntax highlighting: [usr_06.txt](../getting_started/usr_06.md).
