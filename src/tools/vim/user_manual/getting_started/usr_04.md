usr_04 Making small changes `:help usr_04`
...
Next chapter: [usr_05.txt](usr_05.md)  Set your settings<br>
Previous chapter: [usr_03.txt](usr_03.md)  Moving around<br>
...
```text
        "*p
```
This only morks on versions of Vim that include clipboard support. More about the clipboard can be found in section [09.3](usr_09.md#093-the-clipboard) and here: [clipboard](../../gui.md#clipboard)
...
You can find a long list of text objects here: [text-objects](../motion.md#6-text-object-selection)
...
You can find a list of operators here: [operator](../motion.md#1-motions-and-operators).
...
Next chapter: [usr_05.txt](usr_05.md)  Set your settings
